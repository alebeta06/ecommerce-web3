...
const repoRoot = resolve(here, "../../.."); // apps/web-customer/scripts -> repo root
const outDir = resolve(here, "../src/abi");

// 🇪🇸 Solo los ABIs que web-customer consume: la tienda (catálogo/carrito/checkout) y el token
// (balance/approve para pagar).
const SOURCES = [
