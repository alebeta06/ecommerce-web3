...
const repoRoot = resolve(here, "../../.."); // apps/payment-gateway/scripts -> repo root
const outDir = resolve(here, "../src/abi");

// 🇪🇸 Solo los ABIs que la pasarela consume: la tienda (processPayment) y el token (approve/balanceOf).
const SOURCES = [
