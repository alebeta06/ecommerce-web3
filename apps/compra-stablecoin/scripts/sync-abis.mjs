...
const repoRoot = resolve(here, "../../.."); // apps/compra-stablecoin/scripts -> repo root
const outDir = resolve(here, "../src/abi");

// 🇪🇸 Esta app solo consume el token: necesita balanceOf (mostrar saldo) y mint (acuñar EURT tras el
// pago con tarjeta, desde la API route con la wallet owner). Por eso sincronizamos SOLO EuroToken.
const SOURCES = [
